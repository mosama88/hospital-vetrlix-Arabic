                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="mb-0"><img src="{{ asset('dashboard') }}/assets/images/users/user-3.jpg"
                        ...
                        <table class="table table-hover table-centered table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img src="{{ asset('dashboard') }}/assets/images/users/user-2.jpg"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img src="{{ asset('dashboard') }}/assets/images/users/user-3.jpg"
                                                alt="" class="avatar-xs rounded-circle me-2">
                                            Brent Shipley
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img src="{{ asset('dashboard') }}/assets/images/users/user-4.jpg"
                                                alt="" class="avatar-xs rounded-circle me-2">
                                            Robert Sitton
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img src="{{ asset('dashboard') }}/assets/images/users/user-5.jpg"
                                                alt="" class="avatar-xs rounded-circle me-2">
                                            Alberto Jackson
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img src="{{ asset('dashboard') }}/assets/images/users/user-6.jpg"
                                                alt="" class="avatar-xs rounded-circle me-2">
                                            David Sanchez
                                        </div>
                                    </td>
                            ...
                            <li class="clearfix odd">
                                ...
                                <div class="conversation-text">
                                    <div class="ctext-wrap">
                                        ...
                                        <img src="{{ asset('dashboard') }}/assets/images/small/img-1.jpg" alt=""
                                            height="48" class="rounded me-2">
                                        <img src="{{ asset('dashboard') }}/assets/images/small/img-2.jpg" alt=""
